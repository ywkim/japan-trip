...
- **현재 23 페이지** (DOC_PAGES 22개 + decision-log 인덱스 1개):
  ...
  - 후기·안내(4): `viz/kaneyo-review.html`(카네요 방문기 번역 — 5/31 저녁 blog_reviews 목적지)·`viz/shinkyogoku-review.html`(신쿄고쿠 안내 번역 — 5/31 20:00 blog_reviews 목적지)·`viz/excafe-review.html`(eX cafe·아라시야마 카페 비교 — 6/1 12:00, Tabelog 출처)·`viz/manzaratei-review.html`(만자라테이 先斗町店 — 6/1 18:30, Tabelog·ぐるなび 출처)
