...
│   ├── build_index.py   # index.html + viz/*.html(32개) + assets/og-*.svg(6장) + 오프라인 산출물(sw.js·manifest.json·assets/icon.svg) 빌드 (공통 토큰 주입, DOC_PAGES 문서 렌더 + breakfast). 산출물은 gitignore — Vercel·CI·로컬에서 빌드
