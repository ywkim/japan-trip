...
- `viz/kaiten-sushi-review.html` — 교토역 회전초밥 비교 일본어 후기 번역(大起水産 vs 寿しのむさし, 실제 도는 회전 레인). `docs/kyoto-station-kaiten-sushi-translation.md` 정본. 6/2 18:00 저녁 카드에서 탭 진입(카덴쇼 식사 불포함 대체)
